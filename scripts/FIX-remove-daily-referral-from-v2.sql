-- ========================================
-- process_daily_yield_v2から日次紹介報酬を完全削除
-- 実行日: 2026-01-13
-- ========================================
...
BEGIN
  ...
  IF v_distribution_stock != 0 THEN
    INSERT INTO stock_fund (date, amount, source, created_at)
    VALUES (p_date, v_distribution_stock, 'daily_yield', NOW());
...
SELECT 'process_daily_yield_v2 修正完了 - 日次紹介報酬を削除' as status;
