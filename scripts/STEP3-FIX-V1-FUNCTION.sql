...
-- STEP 3: V1システム関数の修正
-- ========================================
-- process_daily_yield_with_cycles 関数に operation_start_date チェックを追加
-- 実行前にSTEP1でバックアップを作成し、STEP2で誤配布を確認してください
-- ========================================

-- この修正により、以下の問題が解決されます：
-- 1. operation_start_date IS NULL のユーザーに日利が配布される問題
-- 2. operation_start_date > 配布日 のユーザーに日利が配布される問題
-- 3. 紹介報酬の計算時に紹介者の operation_start_date がチェックされない問題
-- ========================================
