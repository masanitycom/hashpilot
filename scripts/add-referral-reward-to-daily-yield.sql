-- 日利計算時に紹介報酬も自動的にcum_usdtに反映させる
-- 作成日: 2025年10月7日
-- 目的: 紹介報酬を完全自動化し、NFTサイクルに反映
...
BEGIN
    RAISE NOTICE '===========================================';
    RAISE NOTICE '✅ 紹介報酬自動計算機能を追加';
    RAISE NOTICE '===========================================';
    RAISE NOTICE '変更内容:';
    RAISE NOTICE '  1. 個人利益 → available_usdtに直接加算';
    RAISE NOTICE '  2. 紹介報酬 → cum_usdtに自動反映（今月分の合計）';
    RAISE NOTICE '  3. cum_usdt >= 2200 → 自動NFT付与';
    RAISE NOTICE '';
    RAISE NOTICE '完全自動化:';
    RAISE NOTICE '  ✅ 日利計算実行時に紹介報酬も自動計算';
    RAISE NOTICE '  ✅ NFTサイクルに自動反映';
    RAISE NOTICE '  ✅ 手動操作不要';
    RAISE NOTICE '===========================================';
END $$;
