-- ========================================
-- RPC関数: process_daily_yield_v2 完全版
-- 紹介報酬とNFT自動付与を実装
-- ========================================
--
-- V2システム = 入力を％→＄に変更しただけ
-- 機能は既存システムと同じ：
-- 1. 日利配布（個人利益）
-- 2. 紹介報酬計算・配布（Level1: 20%, Level2: 10%, Level3: 5%）
-- 3. NFT自動付与（cum_usdt >= $2,200で自動付与）
--
-- 修正日: 2025-11-13
-- ========================================
