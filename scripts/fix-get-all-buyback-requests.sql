-- get_all_buyback_requests関数を修正
-- ユーザー情報（email, full_name）を含めて返すように修正
...
BEGIN
    ...
    RAISE NOTICE '=========================================';
    RAISE NOTICE '修正内容:';
    RAISE NOTICE '  - usersテーブルとLEFT JOINしてemail, full_nameを取得';
    RAISE NOTICE '  - request_dateをcreated_atから取得';
    RAISE NOTICE '  - admin_notesを戻り値に追加';
    RAISE NOTICE '=========================================';
END $$;
