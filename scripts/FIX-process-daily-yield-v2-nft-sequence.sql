-- ========================================
-- process_daily_yield_v2関数の修正
-- ========================================
-- 問題: NFT自動付与時にnft_sequenceとnft_valueが設定されていない
-- 修正: nft_sequenceを自動計算、nft_value=1000を設定
-- ========================================
...
BEGIN
  ...
  LOOP
    ...
    -- NFT作成（★ nft_sequence, nft_value 追加 ★）
    INSERT INTO nft_master (
      ...
      p_date,
      NULL,
      calculate_operation_start_date(p_date)
    );
