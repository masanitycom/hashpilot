-- ========================================
-- V2関数のnft_sequenceエラーを修正
-- ========================================
-- 問題: NFT自動付与時にnft_sequenceが指定されていない
-- 修正: nft_sequenceを追加
...
BEGIN
  ...
  LOOP
    INSERT INTO nft_master (
      ...
      v_user_record.user_id,
      'auto',
      v_user_record.auto_nft_count + 1,  -- ← 追加
      p_date,
      NULL
    );
...
SELECT '✅ V2関数のnft_sequenceエラーを修正しました' as status;
