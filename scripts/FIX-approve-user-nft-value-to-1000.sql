-- ========================================
-- approve_user_nft関数のNFT価格を1100から1000に修正
-- ========================================
-- 背景: 全てのNFTは1000ドルで計算（1100ドルのうち100ドルは手数料）
-- 作成日: 2025年10月14日
...
-- 完了メッセージ
SELECT '✅ approve_user_nft関数のNFT価格を1000ドルに修正しました' as status;
