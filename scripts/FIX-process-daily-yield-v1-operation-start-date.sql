-- ========================================
-- 本番環境V1システムの修正: operation_start_dateチェック追加
...
SELECT '修正内容:' as info;
SELECT '1. STEP 2: 個人利益配布時に operation_start_date IS NOT NULL AND operation_start_date <= p_date をチェック' as fix1;
SELECT '2. STEP 3: 紹介報酬配布時に紹介される側と紹介者の両方の operation_start_date をチェック' as fix2;
SELECT '3. STEP 4: NFT自動付与時に operation_start_date をチェック' as fix3;
