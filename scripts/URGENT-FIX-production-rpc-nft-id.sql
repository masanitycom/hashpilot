-- ========================================
-- 緊急修正: 本番RPC関数のnft_id問題を修正
-- ========================================
-- 問題: nft_daily_profitテーブルへの書き込み時にnft_idが指定されていない
-- 修正: nft_masterから実際のNFT IDを取得してループで書き込む
-- ========================================
...
SELECT '✅ 本番RPC関数を修正しました（nft_id問題を解決）' as status;
