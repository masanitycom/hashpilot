...
-- V2関数の重複を解消
-- ========================================
-- 問題: process_daily_yield_v2が複数存在してオーバーロードエラー
-- 解決: 全て削除してから正しい関数を1つ作成
-- ========================================

-- 1. 既存の全てのprocess_daily_yield_v2関数を削除
...
-- 確認
-- ========================================
SELECT '✅ V2関数の重複を解消し、nft_valueエラーを修正しました' as status;
