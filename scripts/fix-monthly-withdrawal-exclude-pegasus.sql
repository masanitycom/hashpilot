...
GRANT EXECUTE ON FUNCTION process_monthly_auto_withdrawal() TO anon;

-- 完了メッセージ
DO $$
BEGIN
    RAISE NOTICE '===========================================';
    RAISE NOTICE 'Monthly withdrawal function updated';
    RAISE NOTICE '===========================================';
    RAISE NOTICE 'Changes:';
    RAISE NOTICE '  - Exclude Pegasus exchange users from auto withdrawal';
    RAISE NOTICE '  - Check pegasus_withdrawal_unlock_date';
    RAISE NOTICE '  - Only process users eligible for withdrawal';
    RAISE NOTICE '===========================================';
END $$;
