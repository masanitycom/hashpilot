-- ========================================
-- V2日利処理関数にuser_daily_profit作成を追加
-- ユーザーダッシュボード互換性のため
-- ========================================
-- 作成日: 2025-11-30
-- 影響: V1には影響なし（V2関数のみ修正）
...
BEGIN
  ...
  -- ========================================
  -- STEP 4.5: user_daily_profitを作成（ダッシュボード互換性）
  -- ========================================
...
COMMENT ON FUNCTION process_daily_yield_v2 IS 'V2日利処理（金額入力、user_daily_profit対応、ダッシュボード互換）';
