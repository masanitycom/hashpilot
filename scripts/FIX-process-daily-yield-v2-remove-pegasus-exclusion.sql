-- ========================================
-- process_daily_yield_v2からペガサス除外条件を削除
-- ========================================
-- 理由: ペガサスユーザーでもoperation_start_dateが設定されている人は運用対象
-- 判定: operation_start_dateが設定されているかどうかで十分
...
BEGIN
  ...
  -- ★ペガサス除外条件を削除（operation_start_dateで判定すれば十分）
  SELECT COUNT(*)
...
SELECT 'process_daily_yield_v2からペガサス除外条件を削除しました（operation_start_dateで判定）' as result;
