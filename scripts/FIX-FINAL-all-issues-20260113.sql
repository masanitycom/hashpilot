...
-- 2. process_monthly_referral_profit関数のnft_sequence/nft_value追加
-- ========================================
...
-- 59C23Cの状態確認
SELECT '=== 59C23C NFT状態 ===' as section;
SELECT
  nm.user_id,
  nm.nft_type,
  nm.nft_sequence,
...
BEGIN
  ...
  RAISE NOTICE '2. process_monthly_referral_profit関数修正';
  RAISE NOTICE '========================================';
END $$;
