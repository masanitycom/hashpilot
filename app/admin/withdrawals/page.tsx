  ...
  const exportCSV = async () => {
    ...
    const csvData = filteredWithdrawals.map((w: any) => {
        ...
        return [
          ...
          w.email,
          w.phase || '-',
          (w.personal_amount || 0).toFixed(2),
          displayReferralAmount.toFixed(2),
          ...
          prevMonthAmount,
          prevMonthStatus,
          cumulativeReferralForCsv.toFixed(2),
          lockAmount.toFixed(2),
          withdrawnReferral.toFixed(2),
          withdrawableFromHold.toFixed(2),
